...
<div class="wrapper">
    ...
    <div class="main_content">
     <h1 align="left" class="header"><span>There </span>is no <span>flying</span> without <span>wing's</span></h1>  
        <div class="info">
<form:form id='userform' action="LoginManager" modelAttribute="user">
  <div class="imgcontainer">
<img src="https://i.pinimg.com/originals/5a/65/ee/5a65ee278cd557143f05a4ba91abbfa8.gif" alt="Avatar" class="avatar"> 
  </div>   
   <form:input type='text' path='managerID' placeholder='Manager ID' required="required" class="manageid"/>
   		<span align="center"  class="error">Please Enter Manager Id</span><br/>
   <form:input type='password' path='password' placeholder='Password' required="required" class="password"/>
    ...
    <h5 align="center" ><a href="#"><font color = "#0000FF">Forgot password ?</font></a></h5>  
   </form:form> 
  </div>
<div class="signup">
  <h4 align="center" >Don't have an account?<a href="ManagerRegistration"><font color = "#0000FF"> Sign up</font></a></h4> 
</div>  
      </div>
    </div>
<script type="text/javascript">
        function Validate() {
            var manageid = document.getElementsByClassName("manageid");
            var error = document.getElementsByClassName("error");
            error[0].style.display = manageid[0].value == "" ? "block" : "none";
            manageid[0].style.border = manageid[0].value == "" ? "1px solid red" : "";
            manageid[0].focus();
