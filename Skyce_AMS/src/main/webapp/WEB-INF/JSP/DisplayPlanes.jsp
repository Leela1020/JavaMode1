...
<body>
	<div class="wrapper">
		...
		<div class="main_content">
			<h1 align="center" class="header">Planes List</h1>
<center>
			<table width="900" class="collapsetable" border="1" style="background-color: white;">
				...
				<c:forEach var="plane" items="${planeList}">
					<tr>
						<td align="center"><c:out value="${plane.planeNo}"></c:out></td>
						<td align="center"><c:out value="${plane.planeID}"></c:out></td>
						<td align="center"><c:out value="${plane.modelName}"></c:out></td>
						<td align="center"><c:out value="${plane.planeCapacity}"></c:out></td>
						<td align="center"><c:out value="${plane.planeType}"></c:out></td>
						<td align="center"><c:out value="${plane.planeCompany}"></c:out></td>
						<td align="center"><a href="updatePlane?planeNo=${plane.planeNo}">Edit </a><a href="deletePlane?planeNo=${plane.planeNo}">Delete</a></td>						
					</tr>
					<br>
					<tr />
					<tr />
