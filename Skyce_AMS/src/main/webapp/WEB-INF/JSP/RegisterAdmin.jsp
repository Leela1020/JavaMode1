	...
	<div class="wrapper">
		<div class="sidebar">
			<ul>
				...
				<li><a href="AdminRegistration"><i class="fas fa-user"></i>Admin Registration</a></li>
			</ul>
		</div>
		<form:form id='userform' action="registerAdmin" modelAttribute="user">
			<div class="main_content">
				...
				<div class="column" style="background-color: white;">
					...
					<form:input type="text" placeholder="Mobile No" class="mobile" path="mobile" required="required"/>
