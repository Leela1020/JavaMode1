...
<body>
	<div class="wrapper">
		...
		<div class="main_content">
			<h1 align="center" class="header">Pilots List</h1>
<center>
			<table width="900" class="collapsetable" border="1" style="background-color: white;">
				...
				<c:forEach var="pilot" items="${pilotList}">
					<tr>
						<td align="center"><c:out value="${pilot.pilotNo}"></c:out></td>
						<td align="center"><c:out value="${pilot.dgcaPilotID}"></c:out></td>
						<td align="center"><c:out value="${pilot.firstName}"></c:out></td>
						<td align="center"><c:out value="${pilot.lastName}"></c:out></td>
						<td align="center"><c:out value="${pilot.age}"></c:out></td>
							<td align="center"><c:out value="${pilot.email}"></c:out></td>
						<td align="center"><a href="updatePilot?pilotNo=${pilot.pilotNo}">Edit</a><a href="deletePilot?pilotNo=${pilot.pilotNo}"> Delete</a></td>
					</tr>
					<br>
					<tr />
					<tr />
